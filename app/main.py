...
import uvicorn
from .routes.filtrado import filtrado_app
from .database.database import start_dbpool, close_dbpool
from .shared.utils import load_db_config,isSettingsFileThere, isLogsDirectoryThere, get_logger_dictConfig, getLoggerLevel

REST_URI = '/v1/teleton/filtrado'

app = FastAPI(title="filtrado-teleton-API",version=1.0)
...
app.include_router(filtrado_app, prefix=REST_URI)
