...
from ..models.models import Mensajes, Users, Diccionario
from ..controller.filtradoController import authenticate_user, get_new_sms, get_new_sms_list, get_user, get_sms, approve_sms, reject_sms, add_dictionary


filtrado_app = APIRouter()
security = HTTPBasic()
...
@filtrado_app.get("/users/{username}")
...
@filtrado_app.put("/sms/approve/{sms_id}")
...
@filtrado_app.put("/sms/reject/{sms_id}")
...
@filtrado_app.post("/sms/dictionary/")
